...
export const REELS: Reel[] = [
  ...
  { slug: 'reel-01', src: '/venues/forest-dew/reel-01.mp4', alt: 'Пара в лодке на пруду с высоты', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-02', src: '/venues/forest-dew/reel-02.mp4', alt: 'Жених надевает кольцо невесте под драпировками', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-03', src: '/venues/forest-dew/reel-03.mp4', alt: 'Фламбе на подаче банкета', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-04', src: '/venues/forest-dew/reel-04.mp4', alt: 'Оранжерея среди сосен, четыре свадебных сезона', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-05', src: '/venues/forest-dew/reel-05.mp4', alt: 'Церемония под белыми драпировками', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-06', src: '/venues/forest-dew/reel-06.mp4', alt: 'Молодожёны в цветах на лесной поляне', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-07', src: '/venues/forest-dew/reel-07.mp4', alt: 'Невеста с бокалом в оранжерее', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-08', src: '/venues/forest-dew/reel-08.mp4', alt: 'Невеста в белом платье перед выходом', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-09', src: '/venues/forest-dew/reel-09.mp4', alt: 'Вечерний банкет с красной подсветкой', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-10', src: '/venues/forest-dew/reel-10.mp4', alt: 'Официанты несут блюда по дорожке в лесу', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-11', src: '/venues/forest-dew/reel-11.mp4', alt: 'Дедушка жениха читает стих в микрофон', author: '', venue: 'forest-dew', sound: true },
  { slug: 'reel-12', src: '/venues/forest-dew/reel-12.mp4', alt: 'Оранжерея с высоты, фишка свадьбы', author: '', venue: 'forest-dew', sound: true },
