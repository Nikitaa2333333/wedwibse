...
export const REELS: Reel[] = [
  ...
  { slug: 'kosareva-moscow', src: '/reels/kosareva-moscow.mp4', alt: 'Пара на крыше напротив сталинской высотки', author: 'kosareva', sound: true },
  { slug: 'kosareva-lilies', src: '/reels/kosareva-lilies.mp4', alt: 'Жених и невеста с букетом лилий у белой арки', author: 'kosareva', sound: true },
  { slug: 'kosareva-ceremony', src: '/reels/kosareva-ceremony.mp4', alt: 'Регистрация у золотой арки и прогулка у воды', author: 'kosareva', sound: true },
  { slug: 'kosareva-party', src: '/reels/kosareva-party.mp4', alt: 'Выездная церемония, танцы и торт с фейерверком', author: 'kosareva', sound: true },
  { slug: 'kosareva-sun', src: '/reels/kosareva-sun.mp4', alt: 'Невеста в контровом солнце на лужайке', author: 'kosareva', sound: true },
